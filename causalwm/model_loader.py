# Adapted by Aether AI for CausalWM (2026) from Lightricks LTX-2 (`ltx-trainer`).
# Distributed under the LTX-2 Community License Agreement; see LICENSE and NOTICE.

# ruff: noqa: PLC0415

"""
Model loader for LTX-2 components using the ltx-core package.
This module provides a unified interface for loading LTX-2 model components
using SingleGPUModelBuilder from ltx-core.
Example usage:
